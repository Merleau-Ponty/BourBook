...
public class BookList extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jTextFieldSearchAuthor = new javax.swing.JTextField(10);
		jLabelSearchAutor = new javax.swing.JLabel();
		jScrollPane1 = new javax.swing.JScrollPane();
		String [] label = {"Titre", "Résumé", "NbPages"};
		DefaultTableModel tableModel = new DefaultTableModel(label,0);
		jTableBookList = new javax.swing.JTable(tableModel);
		jComboBoxSearchCategory = new javax.swing.JComboBox();
		jButtonSearch = new javax.swing.JButton();

		jLabelSearchCategory.setText("Catégories");

		/* Modification jTable */
		jTableBookList.setRowHeight(45);
		...
		jTextFieldSearchAuthor.setText("");
		...
		jButtonSearch.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				if(evt.getActionCommand().contains("Rechercher")){
...
//				else if(evt.getActionCommand().contains("Connexion")){
//					fen.change(6);
//				}
//				else if(evt.getActionCommand().contains("Emprunt")){
//					fen.change(3);
//				}
//				else if(evt.getActionCommand().contains("Auteur")){
//					fen.change(1);
//				}
